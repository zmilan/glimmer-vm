...
export class ListIterator {
  ...
  private phase: Phase = 1;//Phase.Append;
  ...
  constructor({ array, keyFor, target, map, list }: IteratorOptions) {
    ...
    if (list.isEmpty()) {
      this.phase = 0;//Phase.FirstAppend;
    } else {
      this.phase = 1;//Phase.Append;
    }
    ...
    while (true) {
      ...
      switch (this.phase) {
        case 0://Phase.FirstAppend:
          ...
          break;
        case 1/*Phase.Append*/: handled = this.nextAppend(); break;
        case 2/*Phase.Prune*/: this.nextPrune(); break;
        case 3/*Phase.Done*/: this.nextDone(); return true;
      }
