...
// import { parse as parseHBS } from "handlebars/compiler/base";
...
// QUnit.module("[glimmer-syntax] HTML+HBS Parser");
...
// class MixedDelegate implements MixedParserDelegate {
//   constructor(private parser: TestParser) {}

//   get state(): string {
//     return this.parser['htmlParser'].state.name;
//   }

//   html(input: string) {
//     this.parser.tokenize(input);
//   }

//   spanText(loc: HandlebarsAST.Location): string {
//     return '';
//   }

//   content(c: HandlebarsAST.Content) {

//   }

//   mustache(m: GlimmerAST.Mustache) {
...
//   private tokenizer = new EventedTokenizer(this.htmlParser, new EntityParser(HTML5NamedCharRefs))
//   private hbsParser = new MixedParser(new MixedDelegate(this));

//   parse(input: string): GlimmerAST.Program {
//     return this.hbsParser.Program(parseHBS(input));
...
//   private contents() {
//     return this.htmlParser.finalize(this.tokenizer);
//   }
// }

// class HandlebarsBuilder {
//   constructor(private inner: TestBuilder) {}
...
// type BuilderElement = GlimmerAST.Program | Token.OpenedElementBuilder;

// class TestBuilder {
//   public line = 1;
//   public column = 0;
//   private currentTag: Option<Token.OpenTagBuilder> = null;
//   private contents: BuilderElement;
//   private stack: BuilderElement[] = [];
//   private expectFail = false;
//   private logged = false;

//   constructor(public input: string) {
//     let program = GlimmerAST.Program.build();
//     let template = new TemplateContents(new Token.LocationBuilder(this.pos()));
//     this.pushElement(template);
//   }

//   get hbs() {
//     return new HandlebarsBuilder(this);
//   }
...
//   pushElement(element: BuilderElement) {
...
//         this.contents.append(GlimmerAST.Element);
//       } else {
...
//   assertSuccess() {
//     let p = new TestParser();
//     let expected = p.parse(this.input);

//     let ap = new TestParser();
//     let actual = ap.parse(this.toHTML());
...
//   toHTML(): string {
//     return (this.contents as TemplateContents).finalize(this).toHTML();
//   }
...
// function lines(input: GlimmerAST.Program): string[] {
//   let out: string[] = [];

//   input.body.forEach(child => {
//     testChild(out, child);
//   });
...
// function testChild(lines: string[], child: GlimmerAST.StatementNode) {
...
// // expect('dynamic text content', 'hello {{world}}')
// //   .content('hello ')
// //   .hbs.openMustache()
// //   .hbs.path('world')
// //   .hbs.closeMustache();
