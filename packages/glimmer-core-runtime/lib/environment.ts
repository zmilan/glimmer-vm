...
import {
  StatementSyntax
} from 'glimmer-interfaces/lib/syntax/core';

import {
  Args
} from 'glimmer-interfaces/lib/syntax/args';
...
export abstract class Environment {
  ...
  abstract statement(statement: StatementSyntax, symbolTable: SymbolTable): StatementSyntax;
  ...
  abstract attributeFor(element: Simple.Element, attr: string, isTrusting: boolean, namespace?: string): AttributeManager;
