import { Opaque, Destroyable, Option } from '../core';
import { EvaluatedArgs } from '../vm';
import { Environment } from '../environment';
import * as Simple from '../dom';
import { PathReference, RevisionTag } from '../references';
import { Bounds } from '../bounds';
import { DynamicScope } from '../vm/scope';
import { CompiledBlock } from '../vm/blocks';
...
export interface ComponentManager<T extends Component> {
  ...
  getTag(component: T): Option<RevisionTag>;
